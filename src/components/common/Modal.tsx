...
export default function Modal({
  ...
  return (
    <section className="absolute w-screen sm:w-[calc(100vw-79px)] h-full left-0 top-0 flex justify-center">
      ...
      <div className="bg-white flex flex-col opacity-100 w-[95%] sm:w-5/6 z-20 absolute top-8 max-w-[700px] rounded-lg p-3">
        ...
        <div className="px-2 h-auto max-h-[calc(100vh-350px)] sm:h-auto sm:max-h-[calc(100vh-260px)] overflow-auto">{children}</div>
      </div>
    </section>
  );
}
